...
const HomePage = () => {
  ...
  const handleFinalSubmit = async (e) => {
    ...
    // Replicating exactly how ContactPage builds the object structure
    const submitData = {
      ...
      "Estimated Tables": formData.tables,
    ...
    try {
      ...
      // Matches exact response validation condition from ContactPage
